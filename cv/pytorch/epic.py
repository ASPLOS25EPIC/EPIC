...
parser.add_argument("--max_steps", default='100000000000', type=int,
                    help='training max steps')
        ...
        for i, data in enumerate(train_loader):
            if i < args.max_steps:
                ...
                for j in range(0, len(images), args.batch_size):
                    ...
                    # pack
                    if hvd.rank() == 0 and args.diff :
                        optimizer.save_differential_checkpoint(i, '/data/epic/{}_{}_{}_{}_{}-{}_pack{}.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i,args.pack))
                    ...
                    if hvd.rank() == 0 and args.freq > 0 and i % args.freq == 0:
                        ...
                        torch.save({
                            ...
                            'best_acc1': 0,
                            'optimizer' : optimizer.state_dict(),
                        }, '/data/epic/{}_{}_{}_{}_{}_{}_base.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i))
                        end_base = time.time()
