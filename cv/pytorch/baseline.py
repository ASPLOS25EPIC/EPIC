...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #     }, '/data/epic/{}_{}_{}_{}_{}.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch))
    ...
    if hvd.rank() == 0:
        with open("/data/epic/time/{}_{}_{}_{}_time.txt".format(args.model, args.dataset, args.compressor,args.compressor_ratio), 'w') as f:
        ...
        for i, data in enumerate(train_loader):
            if i < 100:
                ...
                for j in range(0, len(images), args.batch_size):
                    ...
                    # if hvd.rank() == 0 and args.diff:
                    #     optimizer.save_differential_checkpoint('/mnt/ramdisk/{}_{}_{}_{}_{}-{}.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i))
                    
                    # pack
                    if hvd.rank() == 0 and args.diff :
                        optimizer.save_differential_checkpoint(i, '/data/baseline/{}_{}_{}_{}_{}-{}_pack{}.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i,args.pack))
                    ...
                    if hvd.rank() == 0 and args.freq > 0 and i % args.freq == 0:
                        ...
                        torch.save({
                            ...
                            'best_acc1': 0,
                            'optimizer' : optimizer.state_dict(),
                        }, '/data/baseline/{}_{}_{}_{}_{}_{}_base.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i))
                        end_base = time.time()
                    ...
                    #         'best_acc1': 0,
                    #         'optimizer' : optimizer.state_dict(),
                    #     }, '/mnt/ramdisk/{}_{}_{}_{}_{}_{}_base.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i))
                    #     end_base = time.time()
                    #     print("base checkpoint takes {}s".format(end_base - begin_base))
