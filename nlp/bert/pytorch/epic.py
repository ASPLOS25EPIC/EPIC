            ...
            for step, batch in enumerate(train_iter):
                if step < 100:
                    ...
                    if hvd.rank() == 0 and args.diff:
                        optimizer.save_differential_checkpoint(step, '/data/ycx/epic/Bert_{}_{}_{}-{}_pack{}.pth.tar'.format(args.compressor,args.compressor_ratio,epoch,step,args.pack))
                    ...
                    if hvd.rank() == 0 and args.freq > 0 and i % args.freq == 0:
                        ...
                        }, '/data/ycx/epic/{}_{}_{}_{}_{}_{}_base.pth.tar'.format(args.model,args.dataset,args.compressor,args.compressor_ratio,epoch,i))
                        end_base = time.time()
