        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_iter):
                if step < 100:
                    ...
                    #     optimizer.save_differential_checkpoint(step, '/data/ycx/baseline/Bert_{}_{}_{}-{}_pack{}.pth.tar'.format(args.compressor,args.compressor_ratio,epoch,step,args.pack))
                    ...
                    if hvd.rank() == 0 and args.freq > 0 and step % args.freq == 0:
                        ...
                        }, '/data/ycx/baseline/Bert_{}_{}_{}-{}_base.pth.tar'.format(args.compressor,args.compressor_ratio,epoch,step))
                        end_base = time.time()
