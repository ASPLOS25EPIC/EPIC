...
def main():
    ...
    parser.add_argument('--json-summary', type=str, default="log/dllogger.json",
    ...
    if args.do_train:
        ...
        optimizer = compression.DistributedOptimizer(
    ...
    if args.do_train:
            ...
            for step, batch in enumerate(train_iter):
                if step < 100:
                    ...
                    if hvd.rank() == 0 and prev_model is not None and args.freq > 0 and step % args.freq == 0:
                        ...
                        }, '/data/delta/Bert_{}_{}_{}-{}_base.pth.tar'.format(args.compressor,args.compressor_ratio,epoch,step))
                        prev_model = copy.deepcopy(model)
                        end_base = time.time()
        ...
        print("time_to_train: ", time_to_train)
